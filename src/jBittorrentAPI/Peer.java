...
public class Peer {
     ...
     * @return int
     */
    public int getDL() { return this.downloaded; }

    /**
     * Returns the total number of bytes uploaded to this peer
     * @return int
     */
    public int getUL() { return this.uploaded;}
     ...
     * @return BitSet
     */
    public BitSet getHasPiece() { return this.hasPiece; }
     ...
     * @return boolean
     */
    public boolean isInterested(){ return this.interested; }
     ...
     * @return boolean
     */
    public boolean isInteresting(){ return this.interesting; }

    /**
     * Returns if this peer is choking or not
     * @return boolean
     */
    public boolean isChoking(){ return this.choking; }

    /**
     * Sets if this peer is intereseted or not
     * @param i boolean
     */
    public void setInterested(boolean i) { this.interested = i; }

    /**
     * Sets if this peer is choked or not
     * @param c boolean
     */
    public void setChoked(boolean c) { this.choked = c; }

    /**
     * Sets if this peer is interesting or not
     * @param i boolean
     */
    public void setInteresting(boolean i) { this.interesting = i; }

    /**
     * Sets if this peer is choking or not
     * @param c boolean
     */
    public void setChoking(boolean c) { this.choking = c; }
     ...
     * @param has boolean
     */
    public void setHasPiece(int piece, boolean has) { this.hasPiece.set(piece, has); }

    public boolean isConnected() { return this.connected; }

    public void setConnected(boolean connectionStatus) { this.connected = connectionStatus; }
     ...
     * @return boolean
     */
    public boolean equals(Peer p) { return this.id == p.getID() && this.ip == p.getIP() && this.port == p.getPort(); }
