 ...
 *@version	$Id: AudioFileFilter.java,v 1.1 2007/03/23 14:16:56 nicov1 Exp $
 *@since	v0.01
 */
public class AudioFileFilter implements FileFilter {
	/**
	 *	<p>Check wether the given file meet the required conditions (supported by the library OR directory).
