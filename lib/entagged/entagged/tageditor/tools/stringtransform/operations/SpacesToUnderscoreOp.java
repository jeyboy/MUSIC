...
/**
 * This operation replaces each space with an underscore (&quot;_&quot;) <br>
 * 
 * @author Christian Laireiter
 */
public final class SpacesToUnderscoreOp extends TransformOperation {

	/**
	 * Creates an instance.
	 */
	public SpacesToUnderscoreOp() {
		super(4, 1);
	}
	...
	public String getDescription() {
		return LangageManager.getProperty("transfo.spacetounderscore");
	}
